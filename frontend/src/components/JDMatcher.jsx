        ...
        <div className="card-elevated p-6 border-t-4 border-teal-500 bg-white shadow-sm">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="p-4 bg-red-50 rounded-lg border border-red-100">
                ...
                <ul className="list-disc list-inside space-y-1 text-red-800">
                    <li key="1">CI/CD pipelines</li>
                    <li key="2">Agile methodology</li>
                    <li key="3">RAG systems</li>
                </ul>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                ...
                <ul className="list-disc list-inside space-y-1 text-green-800">
                  <li key="1">Strong Python experience aligns with backend requirements</li>
                  <li key="2">Docker and Kubernetes experience matches DevOps needs</li>
                </ul>
              </div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <ul className="list-disc list-inside space-y-1 text-blue-800">
                  <li key="1">Quantify achievements in ML projects with metrics (e.g., 'Improved model accuracy by 25% using LocalLM')</li>
                  <li key="2">Add certifications section if you have AWS certifications (e.g., 'AWS Certified Developer - Associate')</li>
                  <li key="3">Emphasize leadership in team projects (e.g., 'Led a team of 3 to develop and deploy a chatbot on AWS Bedrock')</li>
                </ul>
              </div>
            </div>
          </div>
